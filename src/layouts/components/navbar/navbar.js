            ...
            <div className="container-fluid px-0">
               <div className="navbar-header container">
                  ...
                  <Row>
                     ...
                     <b>{submittal.submittalName}</b><br/>{submittal.submittalNo}
                     </Col>
                  ...
                  <Collapse isOpen={this.state.isOpen} navbar>
                     <Nav className="ml-auto float-right" navbar>
                        <UncontrolledDropdown nav inNavbar className="pr-1">
                           <DropdownToggle nav>
                              <ReactCountryFlag code="" svg /> NEW SOUTH CONSTRUCTION
                           </DropdownToggle>
                           <DropdownMenu right>
                              <DropdownItem>
                           ...
                           <DropdownMenu right>
                              <DropdownItem>
                                 <span className="font-small-3">
                                    Maulin Patel <span className="text-muted">(Developer)</span>
                                 </span>
                              </DropdownItem>
